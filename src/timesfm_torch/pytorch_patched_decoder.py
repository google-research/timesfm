...
def _masked_mean_std(
  ...
  It excludes values where `padding` is 1. This should reproduce
  http://google3/learning/multipod/pax/foundation_ts/patched_decoder.py?cl=664903156&l=320
  ...
  Returns:
    ...
    values.
  """
  # TODO(senrajat): will be tested as a part of preprocess input directly.
...
def _shift_padded_seq(mask: torch.Tensor, seq: torch.Tensor) -> torch.Tensor:
  ...
  https://google3/learning/multipod/pax/foundation_ts/patched_decoder.py;l=125.
...
def convert_paddings_to_mask(
  ...
  It should mimic:
  https://google3/third_party/py/praxis/layers/attentions.py;l=191
...
def causal_mask(input_t: torch.Tensor) -> torch.Tensor:
  ...
  It should mimic:
  https://source.corp.google.com/piper///depot/google3/third_party/py/praxis/layers/attentions.py;l=77
...
def merge_masks(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:
  ...
  It should mimic:
  https://google3/third_party/py/praxis/layers/attentions.py;l=127
